...
def get_anthropic_client():
    """Get Anthropic client instance with proper error handling for modern version"""
...
async def analyze_food_image(image_data: bytes, content_type: str) -> Dict[str, Any]:
    """
    Analyze a food image using Anthropic Claude Vision API (modern Messages API)
            ...
            messages=[
                {
                    ...
                    "content": [
                        ...
                        {
                            "type": "text",
                            "text": """Analyze this food image and return ONLY a JSON response with the following structure:
{
    "calories": <number>,
...
Be as accurate as possible with portion size estimation. If you can't clearly identify the food, return calories as 0 and describe what you can see. Return ONLY the JSON, no other text."""
        ...
        # Parse response using modern API format
        content = None
